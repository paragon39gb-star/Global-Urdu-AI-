...
export const AI_UPDATES_PROMPT = `آرٹیفیشل انٹیلیجنس (AI) کی دنیا میں آج کی بالکل تازہ ترین تحقیقی خبریں اور اپڈیٹس فراہم کریں۔`;
...
2. خبریں: ٹاپ بار سے تازہ خبریں حاصل کریں۔
3. AI خبریں: آرٹیفیشل انٹیلیجنس کی تازہ ترین اپڈیٹس دیکھیں۔
4. آڈیو: جوابات سننے کے لیے 'آڈیو' بٹن دبائیں۔
`;
